...
export const Login = ({ onLogin, onBack, isDark, onToggleDark }: any) => {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col bg-[#F8FAFC] dark:bg-[#0B0F19] transition-colors duration-300">
            {/* Header Control Bar */}
            <header className="sticky top-0 z-50 backdrop-blur-md bg-white/70 dark:bg-[#0B0F19]/70 border-b border-gray-200/80 dark:border-gray-800/80 transition-colors pt-[env(safe-area-inset-top)]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <span className="font-black text-lg tracking-tight block text-gray-900 dark:text-white">Team<span className="text-indigo-600 dark:text-indigo-400">AzurLize</span></span>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        {onBack && (
                            ...
                            >
                                <i className="ph-bold ph-house text-sm"></i> <span className="hidden sm:inline">Beranda</span><span className="sm:hidden">Beranda</span>
                            </button>
                        )}
                    </div>
                </div>
            ...
            <main className="flex-1 w-full flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-y-auto">
                {/* Background elements */}
                ...
                {/* THE LOGIN FORM */}
                <div className="w-full max-w-md z-10 mb-8 mt-4">
